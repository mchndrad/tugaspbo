...
private void loadDataToTable2(){
    ...
    String query = "INSERT INTO `barang_masuk`(`id_barang`, `nama_barang`, `harga_barang`, `jumlah_dipesan`, `jumlah_diterima`, `id_penerima`, `nama_penerima`, `tanggal_penerimaan`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    Connection con = DatabaseConnection.getConnection();
    String query = "UPDATE `barang_masuk` SET `nama_barang`= ? ,`harga_barang`= ? ,`jumlah_dipesan`= ? ,`jumlah_diterima`= ? ,`id_penerima`= ? ,`nama_penerima`= ? ,`tanggal_penerimaan`= ?  WHERE id_barang = ?";
    ...
    pst.setInt(8, idBarang);  // Set id_barang sebagai parameter terakhir
